...
TH1F* construct_th(std::string str, TDirectoryFile* fout){
	TDirectoryFile* d1 = (TDirectoryFile*)fout->Get("ch19");
	TDirectoryFile* d2 = (TDirectoryFile*)fout->Get("ch20");
	TDirectoryFile* d3 = (TDirectoryFile*)fout->Get("ch21");
	TDirectoryFile* d4 = (TDirectoryFile*)fout->Get("ch22");
	TDirectoryFile* d5 = (TDirectoryFile*)fout->Get("ch23");
	TDirectoryFile* d6 = (TDirectoryFile*)fout->Get("ch24");
	TDirectoryFile* d7 = (TDirectoryFile*)fout->Get("ch25");
	TDirectoryFile* d8 = (TDirectoryFile*)fout->Get("ch26");
...
//	TDirectoryFile* ds = (TDirectoryFile*)fout->Get("shapes_prefit");
	...
	t_data->SetBinContent(1,36);
	t_data->SetBinContent(2,10);
	t_data->SetBinContent(3,4);
	t_data->SetBinContent(4,24);
	t_data->SetBinContent(5,8);
	t_data->SetBinContent(6,12);
	t_data->SetBinContent(7,9);
	t_data->SetBinContent(8,7);
