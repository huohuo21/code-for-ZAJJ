...
TH1F* construct_th(std::string str, TDirectoryFile* fout){
	TDirectoryFile* d1 = (TDirectoryFile*)fout->Get("ch10");
	TDirectoryFile* d2 = (TDirectoryFile*)fout->Get("ch11");
	TDirectoryFile* d3 = (TDirectoryFile*)fout->Get("ch12");
	TDirectoryFile* d4 = (TDirectoryFile*)fout->Get("ch13");
	TDirectoryFile* d5 = (TDirectoryFile*)fout->Get("ch14");
	TDirectoryFile* d6 = (TDirectoryFile*)fout->Get("ch15");
	TDirectoryFile* d7 = (TDirectoryFile*)fout->Get("ch16");
	TDirectoryFile* d8 = (TDirectoryFile*)fout->Get("ch17");
...
//	TDirectoryFile* ds = (TDirectoryFile*)fout->Get("shapes_prefit");
	...
	t_data->SetBinContent(1,11);
	t_data->SetBinContent(2,2);
	t_data->SetBinContent(3,3);
	t_data->SetBinContent(4,13);
	t_data->SetBinContent(5,8);
	t_data->SetBinContent(6,3);
	t_data->SetBinContent(7,1);
