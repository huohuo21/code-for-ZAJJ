...
void EDBRHistoMaker::Init(TTree *tree) {
	...
	fout = new TFile(out_name.c_str(), "RECREATE");
        ...
        treename->Branch("actualWeight", &actualWeight, "actualWeight/D");cout<<"OKOKOK"<<endl;
	...
	treename->Branch("drj2l", &drj2l, "drj2l/D");
        ...
        treename->Branch("nlooseeles", &nlooseeles, "nlooseeles/D");
        treename->Branch("nloosemus", &nloosemus, "nloosemus/D");
        ...
        treename->Branch("isprompt", &isprompt, "isprompt/D");
...
void EDBRHistoMaker::Loop_for_plj(std::string outFileName) {
	...
	for (Long64_t jentry = 0; jentry < nentries; jentry++) {
		...
		if (lep == 13 && photonet > 25. && HLT_Mu1 > 0 && drj1a >0.7 && drj2a >0.7
