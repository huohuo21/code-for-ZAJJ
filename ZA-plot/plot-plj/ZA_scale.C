...
void ZA_scale(){
	std::string path = "before-ZA-scale-with-zeppcut/";
	...
	std::cout<<"scale of ZA "<<scale<<std::endl; ///  0.791808
	std::cout<<"nMC "<<nMC<<std::endl;  ///  771.909
	std::cout<<"nDMu "<<nDMu<<std::endl; /// 654
	std::cout<<"nZA "<<nZA*lumi<<std::endl; /// 566.349
	std::cout<<"signal contribution in control region "<<nZA_EWK*lumi/nDMu<<std::endl;/// 0.0194099
