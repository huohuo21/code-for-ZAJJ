...
process.TnP_Muon_Trigger = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
        ...
        "/afs/cern.ch/user/m/melu/work/CMSSW_8_0_25/src/MuonAnalysis/TagAndProbe/test/TnPUtils/TnPTree_H.root",
),
        InputTreeName = cms.string("fitter_tree"),
        InputDirectoryName = cms.string("tpTree"),
        OutputFileName = cms.string("TnP_MuonTrigger_noptbin_H.root"),
        NumCPU = cms.uint32(8),
